...
bool Interp4Move::ExecCmd(Scene *wScn) const
{
  ...
  orientation.push_back(obj_on_scene->GetAng_Roll_deg());
  orientation.push_back(obj_on_scene->GetAng_Pitch_deg());
  orientation.push_back(obj_on_scene->GetAng_Yaw_deg());
